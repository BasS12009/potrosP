...
public class DevolucionTraslado extends javax.swing.JFrame {
    ...
    public DevolucionTraslado() {
        ...
        System.out.println("este es el folio que llega a el frame: " + guardar.getFolio());
    ...
    private void cargarInfo(){
        try{
        TrasladoDTO traslado = devolucionFCD.buscar(guardar.getFolio()); 
    ...
    private TrasladoDTO crearDevolucion(TrasladoDTO traslado){
        ...
        // se guarda como true porque su estado cambiara a entregado
        // no porque lo haya hardocodeado profe
        boolean estado = true; 
    ...
    private void devolucion(){
        ...
        TrasladoDTO original = crearDevolucion(devolucionFCD.buscar(guardar.getFolio()));
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 90, 300, 340));
