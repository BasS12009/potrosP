...
public class TrasladoDTO {
    ...
    public TrasladoDTO(String id, String folio, String motivo, int personas, LocalDateTime fechaHoraSalida, LocalDateTime fechaHoraRegreso, boolean disponibilidad, VehiculoDTO vehiculo, VehiculoEntregadoDTO vehiculoEntregado, VehiculoDevueltoDTO vehiculoDevuelto, String correoEmpleado, boolean estado) {
        this.id = id;
        this.folio = folio;
        this.motivo = motivo;
        this.personas = personas;
