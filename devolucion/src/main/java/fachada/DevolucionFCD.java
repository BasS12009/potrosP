...
/**
 * Clase que implementa la interfaz IDevolucionFCD y se encarga de la gestión de devoluciones.
 * La clase utiliza un objeto DevolucionCTL para realizar operaciones relacionadas con devoluciones.
 * 
 * @autor skevi
 */
